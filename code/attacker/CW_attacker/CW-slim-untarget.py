  ...
  for confidence in confidences:
    with tf.Graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            CW = CarliniL2(sess, model, batch_size=batch_size, confidence=confidence, targeted=False, max_iterations=150)
            ...
            np.save("../../../datas/image/CW-untarget-slim-res50-k"+str(confidence),temp)
