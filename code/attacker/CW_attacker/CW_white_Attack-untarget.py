...
from attacks.l2_attack_untarget import CarliniL2
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        ...
        attack = CarliniL2(sess, modelCW,targeted=False, batch_size=batch_size, max_iterations=150,confidence=0)
        vars_dict = {}
        ...
        for i in range(epochs_num):
                ...
                Acc += acc / epochs_num
                np.save("./results/adv-untarget-CW-images-detector",adv_imgs)
        print ("end,",Acc)
