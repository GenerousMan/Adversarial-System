...
if __name__=="__main__":
  ...
  attack_labels = attack_labels.astype(np.int32)
  attack_labels.shape = (1000)
  batch_size = 20
  image_class =1000
  ...
  for ep in ep_s:
    with tf.Session(config=config) as sess:
        ...
        imgs_adv=Tmi_fgsm(model,X,lab_onehot,y_target=True,eps=ep)
        ...
        for i in range(epochs_num):
          ...
          for k in range(10):
            ...
            cv.imwrite("./test/MI-FGSM_0-1-"+str(k)+"_"+str(ep)+".png",Pic_each)
        ...
        np.save("/home/nesa320/Ji_3160102420/other_model_result/TMI-Res50-Slim.npy",adv_images)
        f=open("/home/nesa320/Ji_3160102420/modified_result/accuracy_TMI.txt","a+")
