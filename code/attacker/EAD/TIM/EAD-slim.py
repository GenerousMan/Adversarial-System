...
if __name__=="__main__":
  ...
  attack_labels=np.load("../../../../datas/label/RES-152-LL-LABEL.npy").astype(int)
  ...
  for ep in ep_s:
    with tf.Session(config=config) as sess:
        ...
        cur_accuracy=0
        cur_accuracy2=0
        attack = EADEN(sess, model, batch_size=batch_size, max_iterations=1000, confidence=20,targeted=False)
        ...
        for i in range(epochs_num):
          ...
          adv = attack.attack(imgs_batch, labels)
          print(adv.shape)
          print(adv[0])
        ...
        np.save("../../../../datas/image/EAD-Res50-Slim.npy",adv_images)
        f=open("../../../../datas/image/accuracy_EAD.txt","a+")
        ...
        for i in range(10):
          ...
          img.save("./test/EAD_0-1-"+str(k)+"_"+str(i)+".png")
