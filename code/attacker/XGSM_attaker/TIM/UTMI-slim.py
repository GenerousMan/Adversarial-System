...
if __name__=="__main__":
  ...
  #ep_s=[0.5]
  ks=[6,8,12,20]
  ep_s=[16./255.,32./255.,64./255.,128./255.]
    ...
    with tf.Session(config=config) as sess:   
        ...
        for i in range(epochs_num):
          ...
          for k in range(10):
            ...
            cv.imwrite("./test/TMI-FGSM_0-1-"+str(k)+"_"+str(ep)+".png",Pic_each)
          ...
          logit,acc = sess.run([net,accurary], feed_dict={X: (adv+0.),
                                                          lab:labs_batch})
          cur_accuracy3 += acc * 100 / epochs_num
        ...
        f.write("0-1, res50, "+str(ep*255.)+", acc, "+str(cur_accuracy3)+", success rate, "+str(cur_accuracy2)+"\n" )
        f.close()
        ...
        for i in range(10):
          ...
          img.save("./test/UTMI_0-1-"+str(k)+"_"+str(i)+".png")
